...
(function () {
  ...
  const icons = [
    ...
    { name: 'inapp-message',url: 'icn-inapp-message.svg', category: 'Messaging' },
    { name: 'mobile-push', url: 'icn-mobile-push.svg', category: 'Messaging' },
    { name: 'web-push', url: 'icn-web-push.svg', category: 'Messaging' },
    { name: 'live-activity',url: 'icn-live-activity.svg', category: 'Messaging' },
    ...
    { name: 'arrow-right-2',url: 'icn-arrow-right-2.svg', category: 'Navigation' },
